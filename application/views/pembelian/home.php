<section id="main-content" class="d-flex flex-column justify-content-center bg-white p-2 rounded" style="overflow: auto;">
  <div class="container" data-aos="fade-up">
    <?php
    if ($this->session->flashdata('msg_pemebelian') != NULL) echo $this->session->flashdata('msg_pemebelian');
    ?>
    <div class="row d-flex align-items-center mb-2">
      ...
      <div class="col-md-2 col-12" align="right">
        <a href="<?= site_url('pembelian/add'); ?>" class="btn btn-primary" style="background-color: #feb500;" title="Tambah data">+ Data</a>
      </div>
    </div>
    <div class="bg-white">
