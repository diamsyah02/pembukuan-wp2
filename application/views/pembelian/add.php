...
<script>
  ...
  async function pickProduk(val) {
    let res = await(await fetch(`${url}/produk/getDetail/${val}`)).json()
    document.getElementById('floatingHargaProduk').value = res.result.price
  }
