...
<body>
    ...
    <nav id="navbar" class="navbar nav-menu bg-white p-5 rounded shadow-lg">
      <ul>
        ...
        <li>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" style="fill: white;"><path d="M12 3c-4.963 0-9 4.037-9 9v.001l5-4v3h7v2H8v3l-5-4C3.001 16.964 7.037 21 12 21s9-4.037 9-9-4.037-9-9-9z"></path></svg>
            <span>Logout</span>
          </a>
        </li>
      </ul>
  ...
  <main id="main">
    ...
    ?>
            ...
            <div class="col-md-4 col-12 mb-3">
              <div class="card shadow">
                <div class="card-body p-4">
                  <div class="row d-flex align-items-center">
                    <div class="col-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="75" height="75" viewBox="0 0 24 24" style="fill: #0563bb;">
      ...
      <div class="pt-2 pb-2 text-white" id="judul-app"><pre>copyright &copy; Async <?= date('Y');?></pre></div>
  </main><!-- End #main -->
