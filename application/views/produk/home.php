<section id="main-content" class="d-flex flex-column justify-content-center bg-white p-2 rounded" style="overflow: auto;">
  <div class="container" data-aos="fade-up">
    <?php
    if ($this->session->flashdata('msg_produk') != NULL) echo $this->session->flashdata('msg_produk');
    ?>
    <div class="row d-flex align-items-center mb-2">
      ...
      <div class="col-md-1 col-12">
        <a href="<?= site_url('produk/add'); ?>" class="btn btn-primary" style="background-color: #feb500;" title="Tambah data">+ Data</a>
      </div>
    </div>
    <div class="bg-white">
